 ...
 * Class Credit.
 *
 * This class describes dataset to perform Credit request.
 * Refer to official documentation for more information about Credit request.
 */
class Credit extends Operation implements OperationInterface
{
    /**
     * {@inheritdoc}
     */
