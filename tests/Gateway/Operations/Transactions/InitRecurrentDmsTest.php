...
{
    public function testInitRecurrentDmsHoldSuccess(): void
    {
        $expected = [
    ...
    public function testParsePaymentResponseSuccessfulRedirect(): void
    {
        ...
        $operation = new InitRecurrentDms(new Validator(), new PaymentMethod(), new Money(), new Customer(), new Order(), new System(), new Command());
