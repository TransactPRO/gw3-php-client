...
use TransactPro\Gateway\Responses\ResultResponse;
use TransactPro\Gateway\Validator\Validator;

/**
 * Class Result.
 *
 * This class describes dataset to perform RESULT request.
 * Refer to official documentation for more information about RESULT request.
 */
class Result extends Operation implements OperationInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $response->parseJSON(ResultResponse::class);
    }
}
