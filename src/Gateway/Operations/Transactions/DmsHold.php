 ...
 * Class DmsHold.
 *
 * This class describes dataset to perform DMS HOLD request.
 * Refer to official documentation for more information about DMS HOLD request.
 */
class DmsHold extends Operation implements OperationInterface
{
    /**
     * {@inheritdoc}
     */
    protected $path = '/hold-dms';
